...
# Given an expected returns, covariance matrix, target expected return, find the portfolio that has an expected
# return equal to the target value that minimizes the variance
# ------------------------------------------------------------------------------------------------------
# Input:
#   mean_returns (numpy array): An array with the mean returns of n different stocks
#   cov_matrix (numpy matrix): The (n)x(n) covariance matrix for the stocks
